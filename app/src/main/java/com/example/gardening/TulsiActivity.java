    ...
    private void calculateWaterRequirement() {
        ...
        try {
            ...
            switch (soiltype.toLowerCase()) {
                case "loamy":baseWaterRequirement = daySelection.equals("<14") ? 0.5f : 0.35f;break;
                case "black": baseWaterRequirement = daySelection.equals("<14") ? 0.4f : 0.275f;break;
                case "sandy loam": baseWaterRequirement = daySelection.equals("<14") ? 0.6f : 0.45f;break;
            }
